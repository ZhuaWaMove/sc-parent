 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8881/soap/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://service/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8881/soap/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://service/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "UserServiceImplPort"), UserService.class, features);
    }
