...
public class ObjectFactory {
    ...
    private final static QName _GetNameResponse_QNAME = new QName("http://service/", "getNameResponse");
    private final static QName _GetUser_QNAME = new QName("http://service/", "getUser");
    private final static QName _GetName_QNAME = new QName("http://service/", "getName");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "getNameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service/", name = "getName")
