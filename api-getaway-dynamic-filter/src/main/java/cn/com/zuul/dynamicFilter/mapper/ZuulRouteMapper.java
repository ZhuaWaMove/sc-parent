package cn.com.zuul.dynamicFilter.mapper;
...
public interface ZuulRouteMapper {
	 ...
	 *
	 */
	public void updateZuulRouteVo(@Param("apiName") String apiName, @Param("path") String path);
	/**
	 * 
	 ...
	 *
	 */
	public ZuulRouteVo getZuulRouteVo(@Param("apiName") String apiName);
	/**
	 * 
