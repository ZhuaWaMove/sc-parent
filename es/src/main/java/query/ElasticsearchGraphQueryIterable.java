...
//import org.memgraph.MemgraphException;
//import org.memgraph.elasticsearch5.utils.ElasticsearchDocIdUtils;
//import org.memgraph.query.*;
//import org.memgraph.type.GeoPoint;
//import org.memgraph.type.GeoRect;
//import org.memgraph.util.StreamUtils;
//
//import java.util.*;
//
...
//            throw new MemgraphException("Could not cast aggregation result of type " + result.getClass().getName() + " to type " + resultType.getName());
//        }
...
//                org.memgraph.query.Aggregation queryAgg = query.getAggregationByName(query.getAggregationName(h.getName()));
...
//                }
//            } else {
//                throw new MemgraphException("Aggregation is not a histogram: " + agg.getClass().getName());
//            }
//        }
...
//                }
//            } else {
//                throw new MemgraphException("Aggregation is not a range: " + agg.getClass().getName());
//            }
//        }
...
//                }
//            } else {
//                throw new MemgraphException("Aggregation is not a terms: " + agg.getClass().getName());
//            }
//        }
...
//                }
//            } else {
//                throw new MemgraphException("Aggregation is not a geohash: " + agg.getClass().getName());
//            }
//        }
